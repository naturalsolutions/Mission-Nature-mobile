...
var openFB = (function () {
    ...
    function login(callback, options) {
        ...
        loginWindow = window.open(loginURL + '?client_id=' + fbAppId + '&redirect_uri=' + redirectURL +
            '&response_type=token&scope=' + scope, '_blank', 'location=yes,clearcache=yes,closebuttoncaption=Close');
        ...
        if (runningInCordova) {
            ...
            $(loginWindow).unload(function() {
              loginWindow_loadStartHandler({url:loginWindow.location.href});
            });
        }
